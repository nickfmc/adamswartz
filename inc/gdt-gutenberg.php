...
add_action( 'init', 'maw_register_launch_script' );
function maw_register_launch_script() {
  ...
  wp_register_script( 'swiper', get_template_directory_uri() .'/dist/swiper-bundle.min.js', [ 'acf' ]);
  wp_register_script( 'projects-slider', get_template_directory_uri() .'/template-part/block/swiper-projects/project-slider.js', [ 'swiper' , 'acf' ]);
